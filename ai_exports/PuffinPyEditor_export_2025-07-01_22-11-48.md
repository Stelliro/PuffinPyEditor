...
## Export Timestamp: 2025-07-01T22:11:48.318041
---
...
from PyQt6.QtGui import QPainter, QColor, QPolygonF, QPen, QDrag
...
class FileSystemListView(QWidget):
    ...
    # MODIFIED: These actions now use the more intelligent update methods.
    ...
    # Deletion, duplication, and rename still use a full (but state-preserving) refresh.
    def _action_rename(self, old_path): self.refresh()
    def _action_delete(self, path_to_delete): self.refresh()
    def _action_duplicate(self, path): self.refresh()
```
...
class EditorWidget(QWidget):
    ...
    def __init__(self, completion_manager=None, parent=None):
        ...
        # This remains horizontal for sidebars like line numbers
        ...
        # --- NEW: Vertical layout for the editor and its docked widgets ---
        # This new container will hold the find panel and the text area vertically.
        ...
        # Add the text area to the new vertical layout
        ...
        # Add the entire vertical editor area to the main horizontal layout
