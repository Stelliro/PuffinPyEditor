...
## Export Timestamp: 2025-07-09T16:33:55.776036
---
...
class AIExportViewerPlugin:
    ...
    def open_viewer_tab(self):
        ...
        # THE FIX: We now pass the theme_manager instance to the widget's constructor.
        self.viewer_widget = AIExportViewerWidget(
            theme_manager=self.api.get_manager("theme"),
            parent=self.main_window
        )

        self.main_window.tab_widget.addTab(self.viewer_widget, "AI Exports")
        self.main_window.tab_widget.setCurrentWidget(self.viewer_widget)
