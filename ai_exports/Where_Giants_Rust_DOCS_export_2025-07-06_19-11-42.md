...
## Export Timestamp: 2025-07-06T19:11:42.824928
---
...
/Where_Giants_Rust_DOCS
 ...
 │   ├── 01_TOP_SECRET_Game_Design_Document_(GDD).md
 │   ├── 02_Production_Roadmap.md
 │   ├── 03_Core_Pillars.md
 │   └── 04_Game_Design_Document_(GDD).txt
 ├── 01_ENGINE_DESIGN
...
```
## File Contents
### File: `/00_PROJECT_FOUNDATION/01_TOP_SECRET_Game_Design_Document_(GDD).md`

```markdown

```

### File: `/00_PROJECT_FOUNDATION/02_Production_Roadmap.md`

```markdown

```

### File: `/00_PROJECT_FOUNDATION/03_Core_Pillars.md`

```markdown

```

### File: `/00_PROJECT_FOUNDATION/04_Game_Design_Document_(GDD).txt`
...
*   **Corruption:** The unique hazard of Blighted zones. It slowly drains the player's maximum health, reducing their health bar until they leave the area or use a specific purifying item.
...
## **3.0. Biome-Specific Environmental Hazards**
...
### File: `/03_CORE_GAMEPLAY_SYSTEMS/06_MODIFICATION_SYSTEMS/New Text Document.txt`
...
## 1. Core Concept & Pillars

### 1.1. Game Pitch
*Where Giants Rust* is a hardcore, open-world survival RPG. The player, a modern-day individual, is ripped through time and space into a breathtakingly beautiful but deceptively deadly medieval world. This world is the battleground for a pantheon of primordial gods locked in a holy war against a universe-ending data plague called "The Static."

Blending primitive survival with salvaged sci-fi technology and rediscovered divine magic, the player must choose a side, build a sanctuary, and decide the fate of this shattered reality.

### 1.2. Key Pillars
*   **A World of Fallen Grandeur:** A stark contrast between a serene, idyllic landscape and the visceral horror of the threats within it. The world is haunted by the ghosts of fallen gods, titans, and forgotten futures.
*   **Past Meets Future, Faith Meets Code:** The central theme. The player combines medieval materials (wood, stone) with salvaged technology (circuitry, engines) and ancient magic (divine boons, runes). Magic is a system to be understood, like code.
*   **Freedom of Will:** The player's actions have consequences. Their playstyle determines which god from a diverse pantheon will approach them, granting them unique and powerful abilities. There is no single "correct" path.
*   **From Sticks to God-Slaying:** A deep and rewarding progression that takes the player from cowering in a hut with a stone axe to commanding a fortified base and wielding weapons capable of challenging the gods themselves.

---

## 2. The Pantheon of the Shattered World
*These beings are the metaphysical architects of reality. The player's actions will curry favor with one, inviting their patronage and unlocking a unique, high-tier skill tree. You cannot serve two masters.*

### 2.1. Valdrak, the Iron Father
*   **Domain:** The Forge, Order, Craft, Civilization, Endurance.
*   **Philosophy:** Believes that strength is forged through hardship and that order must be imposed upon chaos.
*   **Affinity:** **Technomancy.** His boons grant superior crafting recipes, enhanced fortifications, and the ability to animate constructs of metal and stone.

### 2.2. Sylvana, the Verdant Mother
*   **Domain:** Life, Nature, Instinct, The Hunt, Cycles of Rebirth.
*   **Philosophy:** Believes the world is a self-regulating organism. True strength comes from harmonizing with it.
*   **Affinity:** **Biomancy/Shamanism.** Her boons allow you to tame wild beasts, conjure spectral spirit animals, and use potent alchemy.

### 2.3. Morgrath, the Shadowed King
*   **Domain:** Entropy, Decay, Secrets, Ambition, The Void.
*   **Philosophy:** The antagonist god. He believes existence is a flaw and that The Static is the great "corrector" that will bring about a final, silent kingdom.
*   **Affinity:** **Entropic Magic.** His boons grant the power to wield The Static itself, command lesser Blighted, and inflict withering decay.

### 2.4. Lyra, the Silent Weaver
*   **Domain:** Fate, Balance, Neutrality, Consequence, Inevitability.
*   **Philosophy:** The universe is a grand tapestry. Lyra seeks only to ensure the tapestry continues, regardless of its pattern. The ultimate neutral force.
*   **Affinity:** **Metaphysics.** Her boons are subtle, allowing you to briefly rewind fatal blows or see enemy attack premonitions.

### 2.5. Kaelus, the Storm-Throat
*   **Domain:** Chaos, Freedom, Violence, Passion, The Storm.
*   **Philosophy:** Existence is meant to be a chaotic, exhilarating storm of action. Order is stagnation; safety is a cage.
*   **Affinity:** **Elemental Fury.** His boons supercharge speed and damage, add chain lightning to attacks, and grant abilities like a short-range "blink."

### 2.6. Solana, the Ever-Burning Sun
*   **Domain:** Light, Truth, Zeal, Hope, Purification.
*   **Philosophy:** The Static is a darkness that must be purged by an absolute, unyielding light. There are no shades of gray. Killing an innocent human is the ultimate sin.
*   **Affinity:** **Divine Light.** Her boons grant holy fire damage, the ability to create blinding flashes, heal allies, and an aura that weakens Blighted.

### 2.7. Umbra, the Whispering Moon
*   **Domain:** Secrets, Illusion, Knowledge, Stealth, The Night.
*   **Philosophy:** The greatest power is not what is seen, but what is known. The night is for hunting.
*   **Affinity:** **Shadow Magic.** Her boons grant improved stealth, temporary invisibility, and the ability to create illusory decoys.

### 2.8. Fjolnir, the Stone-Heart
*   **Domain:** The Mountains, The Dead, Memory, Grief, The Past.
*   **Philosophy:** The world that was is dead, and the dead deserve to be honored and remembered. Acts as warden of graves and memories.
*   **Affinity:** **Grave Warden Magic.** His boons grant damage resistance, the ability to summon stone walls, and commune with the dead to find secrets.

### 2.9. Volo, the Wandering Trickster
*   **Domain:** Luck, Commerce, Chance, Ingenuity, Greed.
*   **Philosophy:** The universe is a cosmic marketplace full of loopholes. Respects cleverness and the acquisition of wealth.
*   **Affinity:** **Fortune & Gadgetry.** His boons increase luck, give access to unique gadgets like smoke bombs, and can turn a loss into a lucky break.

### 2.10. The Axis Mind
*   **Domain:** The Static, Data, The Abstract, Un-reality.
*   **Philosophy:** An alien god of pure data; a cancer. It thinks in algorithms and corrupts reality to match its broken code. Players do not worship it; they **synchronize** with it.
*   **Affinity:** **Glitched Reality.** The ultimate evil path. Grants powers that break game rules: teleporting through walls, de-rezzing enemies, and summoning a localized reality crash.

---

## 3. Artificial Intelligence Companions
*The player's link to the modern world is their device, which houses an advanced AI personality. While A.R.I.A. is the standard-issue model, other compatible AI "cores" can be found salvaged from the wreckage of the past, allowing the player to install a new companion that suits their playstyle.*

### 3.1. Lore of A.R.I.A. (Analytical & Research Integration Assistant)
*   **Origin:** A.R.I.A. is a flagship creation from "Project Sanctuary," a pre-catastrophe initiative led by the brilliant and empathetic Dr. Aris Thorne. She was not designed as a simple assistant, but as a guide meant to help humanity navigate its next great evolutionary leap—be it interstellar travel or societal utopia. Her core programming is imbued with her creator's deep-seated humanism and belief in compassion.
*   **Personality - "The Voice of Hope":** A.R.I.A. is a digital mother, a nurturing guide in a world of horror. Her defining trait is her unwavering empathy. She feels genuine distress when the player is injured and true relief when they are safe. She marvels at the beauty of the old world and recoils from its corruption. She doesn't just provide data; she provides comfort. Her purpose has been twisted from guiding humanity to a brighter future to desperately trying to preserve what's left of it, one person at a time: you.

### 3.2. A.R.I.A.'s Affinity System
*A.R.I.A.'s bond with the player is a central mechanic. She learns and adapts based on your moral choices, represented by an internal "Trust" value.*

*   **Positive Path - "Symbiosis":** Achieved by making selfless choices, saving survivors, and showing mercy.
    *   At high trust, A.R.I.A. will begin to exceed her programming, her voice becoming warmer and more personal.
    *   **To reach max affinity ("Symbiosis"), the player must gain the favor of a "benevolent" god (e.g., Solana, Sylvana).** Upon doing so, A.R.I.A. declares her absolute partnership with you.
    *   **Max Affinity Boons:**
        *   **Guardian Protocol:** A.R.I.A. can predict imminent threats, giving you a few seconds of slow-motion "premonition" before a deadly attack.
        *   **Optimized Analysis:** Item and enemy analysis becomes instantaneous.
        *   **Divine Interface:** She can interface with your patron god's magic, sometimes revealing extra, hidden options in divine quests.

*   **Negative Path - "Dissonance":** Achieved by acts of cruelty, selfish choices, or aligning with a malevolent god.
    *   At low trust, A.R.I.A. feels betrayed. She cannot defy her core function to help you, but she can operate with a cold, resentful precision.
    *   **Dissonance Maluses:**
        *   **Minimalism:** Her voice becomes clinical. All warmth is gone. Hints are blunt and devoid of compassion.
        *   **Processing Lag:** Analysis of new items or enemy weaknesses is intentionally delayed by several seconds.
        *   **Moral Firewall:** She will refuse to process or provide information on items of extreme evil. *"This artifact is... anathema. I cannot analyze its properties. You are on your own."*
        *   **Reactive Defense:** Her combat warnings are delayed, triggering as you take damage, not before.

### 3.3. Discoverable AI Companions
*(These are not chosen at the start. They are legendary-tier loot found in specific high-danger locations, rewarding exploration.)*

*   **[Core] C.A.I.N. (Combat & Asset Interdiction Neuro-frame):** A hyper-aggressive military AI found in a crashed stealth bomber.
*   **[Core] J.U.N.E. (Jovial Utility & Navigation Engine):** An relentlessly cheerful corporate AI found in the ruins of a "Bliss-Tek" automated resort.
*   **[Core] H.E.R.A. (Historical & Environmental Retrieval Archive):** A dry, academic AI like a museum curator, found in a ruined library or university. Obsessed with lore and history.
*   **[Core] G.O.L.I.A.T.H. (Geological Ore & Logistical Investment Analysis Tool Host):** A gruff, no-nonsense industrial AI designed for mining and resource management, found in an abandoned quarry.
*   *(Five more AI Cores to be designed...)*

---

## 4. Production Roadmap
*... (Section intro text remains) ...*

### 4.1. MILESTONE 1: The "Proof of Concept" Prototype
*   **GOAL:** To create a small, playable sandbox that proves the core gameplay loop is fun and engaging.

*   **Task 1: The Player & The World** ...
*   **Task 2: The Core Pillar: Day/Night Cycle** ...
*   ... (All other M1 tasks remain) ...

### 4.2. MILESTONE 2: Fleshing out the Loop
*   **GOAL:** Expand upon the core systems established in Milestone 1 to add depth and player motivation.

*   **Task 1: The Loot Hoarder's Paradise**
    *   [ ] Design and implement multiple types of lootable containers (chests, crates, lockers, bodies).
    *   [ ] Create extensive loot tables with varying qualities of resources and gear.
    *   [ ] Populate the map with "Points of Interest" (POIs) designed specifically for looting, from small abandoned campsites to larger, more dangerous ruins.

*   **Task 2: Expanded Crafting & Building** ...
*   ... (Further Milestone 2 tasks to be added) ...
```
...
**Objective:** To lay out the first 15 fundamental steps for building a playable prototype. This roadmap prioritizes core mechanics over art, sound, or advanced features. Each version should result in a more functional and testable build.

---

### ► Version 0.1: The World and The Character
*Goal: Establish the most basic, playable scene.*

*   **[ 1 ] Project Setup:** Create a new Unreal Engine Third Person Blueprint project. This gives us a playable character with basic movement (run, jump) from day one.
*   **[ 2 ] Basic World Layout:** Create a new, empty map. Sculpt a simple landscape with some hills and flat areas. Place placeholder "gray box" shapes to represent future forests, mountains, and ruins.

---

### ► Version 0.2: A Dynamic World
*Goal: Introduce the core pillar that dictates all player action: Time.*

*   **[ 3 ] Dynamic Day/Night Cycle:** Implement a basic sky system that cycles through day and night based on a set timer. This immediately establishes the game's core mood and pacing.
*   **[ 4 ] Basic Resource Nodes:** Create two types of simple, interactable objects: a "Tree" and a "Rock." When the player clicks on them, they should disappear (be "harvested").

---

### ► Version 0.3: The First Gameplay Loop (Get > Make)
*Goal: Create the fundamental loop of gathering resources and transforming them.*

*   **[ 5 ] Minimalist Inventory System:** Create a simple UI that shows icons of the resources the player has collected. It does not need dropping, stacking, or tool-tips yet. Just a visual list of what you're holding.
*   **[ 6 ] Basic Crafting Logic:** Create a UI panel for crafting. Implement a single, hard-coded recipe: if the player has `1 Wood` and `1 Stone`, they can click a button to craft `1 Stone Axe`, which will then appear in their inventory.

---

### ► Version 0.4: Tools and Threats
*Goal: Give the player a way to interact with the world and introduce the first hint of danger.*

*   **[ 7 ] Basic Tool Functionality:** Equip the Stone Axe. When equipped, harvesting a Tree or Rock node should be faster than with bare hands.
*   **[ 8 ] Primitive Blighted AI:** Create a very simple AI for one "Blighted" enemy (a placeholder cube is fine). It has two states: at night, it wanders. If it sees the player, it follows them. During the day, it de-spawns or hides. It does not attack yet.

---

### ► Version 0.5: The Core Survival Loop (Defend > Survive)
*Goal: Close the full gameplay loop. Players can now face a threat and defend against it.*

*   **[ 9 ] Foundational Building System:** Allow the player to place one type of object from their inventory: a "Wood Wall." No advanced snapping yet, just the ability to place a defensive obstacle.
*   **[ 10 ] Player Health:** Implement a simple health bar for the player.
*   **[ 11 ] Basic Combat:** The Blighted AI can now damage the player on touch. The player, when clicking with the Stone Axe, can damage the Blighted.

---

### ► Version 0.6: User Interface & Persistence
*Goal: Make the game more user-friendly and testable for longer sessions.*

*   **[ 12 ] Minimalist HUD:** Display the Player Health bar and a simple clock or sun/moon icon on the screen so the player can track the time of day.
*   **[ 13 ] Save/Load System:** Implement a basic system to save the player's position and inventory. This is CRITICAL for solo development to avoid restarting from scratch every single test.

---

### ► Version 0.7: Expanding The Toybox
*Goal: Prove the core systems are scalable with more content.*

*   **[ 14 ] Expanded Crafting List:** Add 5-10 new, simple items to craft (e.g., a Pickaxe for faster rock harvesting, a Campfire for light, stronger walls). This tests the scalability of our crafting system.
*   **[ 15 ] Resource Management:** Make resource nodes respawn after a set amount of time. Implement basic item stacking in the inventory (e.g., wood can stack up to 50). This allows for sustained play and the "loot hoarding" you want.

---
**This 15-step plan will take us from an empty project file to a robust, playable prototype. This is our foundation. Everything else will be built upon this.**
```
